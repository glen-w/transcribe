...
| AnalysisBatchRun | Planned durable bulk Analyse across notebooks (orchestration only) | [bulk_run_analysis_plan.md](bulk_run_analysis_plan.md) (CONTRACT lands with implementation) |
