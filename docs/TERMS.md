...
| AnalysisRunPlan | Frozen Analyse batch inputs (modules, EffectiveConfig, text-model identity) | [contracts/analysis-run-storage.md](contracts/analysis-run-storage.md) |
