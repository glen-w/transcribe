...
4. Run notebook analysis on transcribed text (Overview, Themes, Mood & tone, Moments, People & places, Summaries, Ask notebook, Detect under **View**; corpus Places map in the primary nav)
