...
| Audience | Go here |
|----------|---------|
| New users | [USER_INDEX.md](USER_INDEX.md) → [user_guide.md](user_guide.md) |
...
| Product / roadmap | [PRODUCT.md](PRODUCT.md) · [ROADMAP.md](ROADMAP.md) (core modules shipped) · [analysis_wave1_plan.md](analysis_wave1_plan.md) (internal delivery history) |
